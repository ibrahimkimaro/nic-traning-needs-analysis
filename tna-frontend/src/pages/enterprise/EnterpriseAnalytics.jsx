            ...
            <div className="flex border-b border-slate-200/80 dark:border-slate-800 overflow-x-auto custom-scrollbar gap-2 pb-px w-full">
                {[
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 py-3 px-4.5 font-bold text-xs uppercase tracking-wider transition-all border-b-2 whitespace-nowrap ${activeSubTab === tab.id
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                {Object.entries(categoryHalfLives).map(([key, item]) => (
                                    <button
                                        ...
                                        className={`p-3.5 rounded-2xl border text-left text-xs transition-all ${decayParams.category === key
